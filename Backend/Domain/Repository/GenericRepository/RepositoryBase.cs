...
namespace Task_Management_System.Domain.Repository.GenericRepository
{
    public class RepositoryBase<TEntity> : IRepositoryBase<TEntity> where TEntity : class
    {
        ...
        public RepositoryBase(TaskDbContext context) => _context = context;
        ...
        public bool RemoveList(IEnumerable<TEntity> entities)
        {
        ...
        public async Task<IReadOnlyList<TEntity>> GetPagedResponseAsync(int pageNumber, int pageSize, Expression<Func<TEntity, bool>> predicate, params string[] includes)
        {
